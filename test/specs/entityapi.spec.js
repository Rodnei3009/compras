define([ 'require'
    ...
    describe( "EntityAPI", function(){
        ...
        it( "should return simple types as undefined", function(){
            ...
            expect( (typeof entities.get( "string", undefined, true )).toLowerCase() ).toBe( "undefined" );

            expect( entities.get( "string", undefined, true  ) ).not.toBeDefined();

            expect( (typeof entities.get( "number", undefined, true )).toLowerCase() ).toBe( "undefined" );
            expect( entities.get( "number", undefined, true  ) ).not.toBeDefined();

            expect( (typeof entities.get( "boolean", undefined, true )).toLowerCase() ).toBe( "undefined" );
        ...
        it( 'Inner tests (implementation specific)', function(){
            ...
            expect( entities._types["TestStruct"] ).toBeDefined();
            expect( _.isFunction(entities._types["TestStruct"]) ).toBeTruthy();
        });

        it( "Exceptions", function(){
            var entities = new EntityFactory();
            expect( entities.get.bind(entities, "NotExistedTypeName") ).toThrowError();
            expect( entities.get.bind(entities, "NotExistedTypeName") ).toThrowError( Entity_api.TypeNotFoundError );
        });
