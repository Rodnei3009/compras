                ...
                return {
                    request: function( config ) {
                        if ( config.hasOwnProperty('aio_config') ){
                            ...
                            if ( c.hasOwnProperty('responseType') && c.responseType.toLowerCase() === 'jsonp' ) {
                                config.method = 'jsonp';
                            }
                        }
                        return config;
                    ...
                    response: function( response ){
                        if ( response.config.hasOwnProperty('aio_config') && response.config.aio_config.hasOwnProperty('responseType') ){
                            var c = response.config.aio_config;
                            if ( c.responseType.toLowerCase() === 'xml' ) {
