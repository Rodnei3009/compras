...
"backButton", "navigateTo"], function() {
    ...
    var __APP_NAME__ = 'compras';

    /**
     * Adding angular modules to the application
     */
    var APP = angular.module(__APP_NAME__, ['ApperyioModule', "ngAnimate", "uiGmapgoogle-maps"]).config(["$routeProvider", '$controllerProvider', '$provide', '$locationProvider', '$compileProvider', '$filterProvider', Configuration]).run(["Apperyio", "User", RUN]);
